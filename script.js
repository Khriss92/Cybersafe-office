...
const INTERLUDE_PUZZLES = [
  {
    type: "fragment-build",
    title: "After-Task Puzzle",
    taskLabel: "Phishing",
    prompt: "You just finished the phishing task. Rebuild the suspicious message clue by choosing the risky parts.",
    hint: "Phishing emails often use urgency, strange support wording, and suspicious endings.",
    successText: "Correct. Urgency and suspicious wording are classic phishing warning signs.",
    fragments: [
      { id: "frag-reset", text: "Reset" },
      { id: "frag-meeting", text: "Meeting" },
      { id: "frag-now", text: "Now" },
      { id: "frag-payroll", text: "Payroll" },
      { id: "frag-click", text: "Click" },
      { id: "frag-fast", text: "Fast" },
    ],
    required: ["frag-reset", "frag-now", "frag-click", "frag-fast"],
  },
  {
    type: "toggle-set",
    title: "After-Task Puzzle",
    taskLabel: "Password Strength",
    prompt: "You just built a password. Switch on the rules that make a password strong.",
    hint: "Good passwords are long, mixed, and hard to guess.",
    successText: "Exactly. Strong passwords rely on length, variety, and unpredictability.",
    options: [
      { id: "length", title: "Make it long", body: "Longer passwords resist guessing better." },
      { id: "mix", title: "Mix character types", body: "Use letters, numbers, and symbols." },
      { id: "unique", title: "Keep it unique", body: "Do not reuse easy common patterns." },
      { id: "predictable", title: "Use Password123", body: "This is weak and predictable." },
    ],
    required: ["length", "mix", "unique"],
  },
  {
    type: "counter",
    title: "After-Task Puzzle",
    taskLabel: "Device Security",
    prompt: "You secured the workstation. Count how many protective actions belong in that task.",
    hint: "Think about patching, scanning, and firewall protection.",
    successText: "Right. Device safety comes from several simple protections working together.",
    min: 0,
    max: 4,
    target: 3,
    labels: [
      ...
      "Run security scan",
      "Keep firewall on",
      "Disable protection warnings",
    ],
  },
  {
    type: "match-pair",
    title: "After-Task Puzzle",
    taskLabel: "IDS Detection",
    prompt: "You just reviewed IDS alerts. Match the suspicious event to the reason it matters.",
    hint: "The key idea is noticing warning patterns, not normal office activity.",
    successText: "Correct. IDS helps detect suspicious behavior before it becomes a bigger problem.",
    leftLabel: "Alert",
    rightLabel: "Meaning",
    optionsLeft: [
      { id: "printer", title: "Printer synced", body: "Normal office event" },
      { id: "bad-ip", title: "Repeated failed logins", body: "Warning sign in the alert stream" },
      { id: "calendar", title: "Calendar update", body: "Routine activity" },
    ],
    optionsRight: [
      { id: "routine", title: "Normal office activity", body: "Usually not a security issue" },
      { id: "block", title: "Suspicious pattern", body: "Needs investigation" },
      { id: "ignore", title: "Ignore everything", body: "Unsafe choice" },
    ],
    correctLeft: "bad-ip",
    correctRight: "block",
  },
  {
    type: "stepper",
    title: "After-Task Puzzle",
    taskLabel: "IPS Prevention",
    prompt: "You blocked a hostile source. Set the threat response level to the strongest action.",
    hint: "IPS is about prevention, not passive watching.",
    successText: "Right. When the threat is known, strong prevention is the safer move.",
    min: 3,
    max: 5,
    target: 5,
    unit: "shield level",
  },
  {
    ...
    title: "After-Task Puzzle",
    taskLabel: "Fail2Ban",
    prompt: "You handled repeated failed logins. Choose the item that needs to be locked down fast.",
    hint: "Brute-force defense means isolating the risky source or target quickly.",
    successText: "Good. Quick lockout measures help contain repeated login abuse.",
    options: [
      { id: "mystery", title: "Account with 10 failed logins", body: "Shows repeated access abuse." },
      { id: "tagged", title: "Normal staff account", body: "No signs of attack." },
      { id: "sealed", title: "Printer service account", body: "Routine background activity." },
    ],
    correct: "mystery",
  },
  {
    ...
    title: "After-Task Puzzle",
    taskLabel: "USB Safety",
    prompt: "You found a suspicious USB. Tap the safe response order.",
    hint: "Do not explore it first. Contain it, then involve the right team.",
    successText: "Exactly. Unknown USB devices should be isolated and reported, not tested.",
    options: [
      { id: "quarantine", title: "Quarantine the USB" },
      { id: "plug-in", title: "Plug it in to inspect it" },
      { id: "report", title: "Report it to IT" },
    ],
    sequence: ["quarantine", "report"],
  },
  {
    type: "paired-choice",
    title: "After-Task Puzzle",
    taskLabel: "MFA Push",
    prompt: "You handled an unexpected MFA request. Pick the safer action plan.",
    hint: "Unexpected sign-in prompts should be denied and treated as suspicious.",
    successText: "Correct. Never approve a sign-in you did not request.",
    connections: [
      { id: "public-wifi", title: "Approve the push", body: "Unsafe if you did not request it" },
      { id: "hotspot", title: "Deny the push", body: "Stops the unexpected sign-in request" },
      { id: "shared", title: "Ignore and hope it stops", body: "Too passive" },
    ],
  ...
  },
  {
    type: "combo-build",
    title: "After-Task Puzzle",
    taskLabel: "Wi-Fi And VPN",
    prompt: "You secured remote work. Build the safer connection plan using the correct two pieces.",
    hint: "Choose the safer connection method and the added protection layer.",
    successText: "Right. Safe remote work uses a safer connection plus VPN protection.",
    keys: ["Hotspot", "VPN", "Open Wi-Fi", "Ignore"],
    required: ["Hotspot", "VPN"],
  },
  {
    type: "classify-card",
    title: "After-Task Puzzle",
    taskLabel: "Screen Lock",
    prompt: "You stepped away from the desk. Which label best fits an unlocked screen?",
    hint: "An unlocked workstation is not safe just because it is inside the office.",
    successText: "Exactly. An unlocked screen is a security risk in any workplace.",
    labels: ["Safe", "Risky", "Private"],
    correct: "Risky",
  },
  {
    type: "url-segment",
    title: "After-Task Puzzle",
    taskLabel: "Data Classification",
    prompt: "You sorted office information. Tap the item that shows why stronger protection is needed.",
    hint: "Some details need more protection because they contain private staff information.",
    successText: "Correct. Sensitive data needs stronger handling and access control.",
    segments: [
      { id: "seg-https", label: "Published brochure" },
      { id: "seg-lookalike", label: "Salary spreadsheet" },
      { id: "seg-domain", label: "Team rota" },
    ],
  ...
  },
  {
    type: "slot-builder",
    title: "After-Task Puzzle",
    taskLabel: "Safe Website Check",
    prompt: "You checked for a safe website. Fill the trust checks with the three safest signs.",
    hint: "Think about the exact address, secure connection, and familiar company domain.",
    successText: "Good. Careful website checks help prevent credential theft.",
    slots: 3,
    options: [
      { id: "cloud", title: "Correct company domain" },
      { id: "external", title: "HTTPS secure connection" },
      { id: "schedule", title: "No spelling tricks" },
      { id: "same-device", title: "Strange login URL" },
      { id: "never-test", title: "Lookalike letters" },
    ],
  ...
  },
  {
    type: "timeline-rank",
    title: "After-Task Puzzle",
    taskLabel: "Backup Builder",
    prompt: "You built a backup plan. Rank the backup habits in their best learning order.",
    hint: "Start with extra copies, keep them regular, and avoid keeping everything on one device.",
    successText: "Correct. Strong backups rely on multiple copies and routine scheduling.",
    steps: [
      { id: "report", title: "Use more than one copy" },
      { id: "secure", title: "Run backups regularly" },
      { id: "details", title: "Avoid one-device-only storage" },
    ],
    correctRanks: {
      report: 1,
      secure: 2,
...
function showInterludeCard() {
  ...
  const currentTask = TASKS[appState.currentTask];
  const nextTask = TASKS[appState.currentTask + 1];

  if (!puzzle || !currentTask || !nextTask) {
    goToNextTask();
    return;
  }

  setTopicTheme(currentTask.id);
  sceneContainer.innerHTML = `
    <section class="task-stage">
      <div class="interlude-card pulse">
        <div class="interlude-header">
          <div>
            ...
            <h3>${escapeHtml(puzzle.taskLabel || currentTask.name)}</h3>
          </div>
